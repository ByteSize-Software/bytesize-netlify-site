...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.service-category, .service-item, .learn-category, .contact-item');
...
console.log(`
🚀 ByteSize, LLC Website
Built with modern web technologies
For support: cannon@bytesizesoftware.net
`);
